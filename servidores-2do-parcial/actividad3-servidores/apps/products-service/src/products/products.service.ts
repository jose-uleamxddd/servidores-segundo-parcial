...
import { WebhookEventType, ProductStockReservedData } from '../../../shared/webhook-events.types';
...
export class ProductsService {
  ...
  async processStockRequest(payload: {
    ...
    // ========================================
    // PASO 6: PUBLICAR WEBHOOK EXTERNO
    // ========================================
    const webhookData: ProductStockReservedData = {
      orderId,
      productId,
      quantity,
      success: true,
    ...
    await this.webhookPublisher.publishWebhook({
      event: WebhookEventType.PRODUCT_STOCK_RESERVED,
      version: '1.0',
      id: uuidv4(),
